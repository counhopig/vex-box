/**
 * Backend log streamer tests — tails the pino JSON log file.
 *
 * Ported from _archive/tests/log-stream.test.ts. The streamer reads whichever
 * file getLogFile() points at; the test redirects it to a temp file to drive
 * tailing and day-rollover deterministically.
 */
...
import { LogStreamer, type BackendLogEntry } from "../src/web/routes/log-stream.js";
...
describe("web/routes/log-stream", () => {
  let dir: string;
