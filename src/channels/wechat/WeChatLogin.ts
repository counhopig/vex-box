 ...
 *
 * Implements QR code scan login via iLink OC API, automatically polling QR
 * code status until the user confirms or the code expires. Ported from
 * _archive/src/channels/weixin/login.ts.
 */

import { getChildLogger } from "../../utils/logger.js";
import { renderQrTerminal } from "./qr.js";
import { WeChatClient, DEFAULT_WEIXIN_OC_BASE_URL } from "./WeChatClient.js";
import type { QRStatusResponse } from "./WeChatClient.js";
