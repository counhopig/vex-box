...
const zh: Record<string, string> = {
  ...
  "Admin-only account management for Web UI users": "管理 Web UI 用户账号（仅管理员）",
  "Web Users": "Web 用户",
  "Username": "用户名",
  "Role": "角色",
  "Weixin": "微信",
  ...
  "Delete user": "删除用户",
  "Delete this user and their login sessions?": "删除该用户及其登录会话？",
  "User deleted": "用户已删除",
  "Configuration": "配置",
  "Config": "配置",
  "Settings": "设置",
  "Manage models, channels, capabilities, and runtime settings": "管理模型、渠道、能力与运行设置",
  "All changes saved": "所有更改已保存",
  "Unsaved changes": "有未保存的更改",
  "Discard & Reload": "放弃并重新加载",
  "Save Changes": "保存更改",
  "Core": "核心",
  "Capabilities": "能力",
  "System": "系统",
  "Agent & Model": "Agent 与模型",
  "Providers": "模型提供商",
  "Persona": "人格",
  "Runtime": "运行环境",
  "Advanced YAML": "高级 YAML",
  "Advanced persona behavior": "高级人格行为",
  "Discard changes?": "放弃更改？",
  "Your unsaved settings will be lost.": "未保存的设置将会丢失。",
  "Discard": "放弃",
